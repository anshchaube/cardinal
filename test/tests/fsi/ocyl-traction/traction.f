...
c            drag_x = drag_x + (
c     $        tauij(j1,j2,1,1,e)*unx(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,4,e)*uny(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,6,e)*unz(ia,1,f,e)*area(ia,1,f,e) )
c
c            drag_y = drag_y + (
c     $        tauij(j1,j2,1,4,e)*unx(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,2,e)*uny(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,5,e)*unz(ia,1,f,e)*area(ia,1,f,e) )
c
c            drag_z = drag_z + (
c     $        tauij(j1,j2,1,6,e)*unx(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,5,e)*uny(ia,1,f,e)*area(ia,1,f,e)
c     $      + tauij(j1,j2,1,3,e)*unz(ia,1,f,e)*area(ia,1,f,e) )
...
c      drag_x = glsum(drag_x,1)
c      drag_y = glsum(drag_y,1)
c      drag_z = glsum(drag_z,1)
c
c      if (nio.eq.0) then
c        write(*,71) drag_x  
c        write(*,72) drag_y  
...
c      endif
c      
c71    format(1p1e20.13,': ansh drag x ')
c72    format(1p1e20.13,': ansh drag y ')
c73    format(1p1e20.13,': ansh drag z ')
